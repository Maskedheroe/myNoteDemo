...
// extends  RecyclerView.Adapter<GridAdapter.SelectedPicViewHolder>
  /*  private int maxImgCount;
    ...
    public GridAdapter(Context mContext, List<ImageItem> data, int maxImgCount) {
    ...
    @Override
    public void onBindViewHolder(GridAdapter.SelectedPicViewHolder holder, int position) {
